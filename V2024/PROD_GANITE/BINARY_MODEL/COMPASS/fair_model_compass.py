...
prefix="/Users/german.sanchez/Desktop/PAPER1/PROD_GANITE/DATA_PROD/BINARY/COMPASS/ORIGINAL/"
prefix_ganite="/Users/german.sanchez/Desktop/PAPER1/PROD_GANITE/DATA_PROD/BINARY/COMPASS/GANITE/"
prefix_results="/Users/german.sanchez/Desktop/PAPER1/PROD_GANITE/BINARY_MODEL/COMPASS/RESULTS/"
version='vc2.csv'
...
print((X_train.shape))
train_t=train_t.reshape([4937,1])
X_train = np.append(X_train, train_t, axis=1)
print((X_train.shape))

print((X_test.shape))
test_t=test_t.reshape([1235,1])
...
def data_loader(alpha_ganite):
    suf="_alpha_"+str(alpha_ganite)+'_compass'+version
    ...
    train_y_hat_ganite=test_y_hat_ganite[0:4937]
    test_y_hat_ganite=test_y_hat_ganite[4937:4937+1235]
    ...
    #print((X_train_ganite.shape))
    train_t_ganite=train_t_ganite.reshape([4937,1])
    X_train_ganite = np.append(X_train_ganite, train_t_ganite, axis=1)
    #print((X_train_ganite.shape))
    #print((X_test_ganite.shape))
    test_t_ganite=test_t_ganite.reshape([1235,1])
