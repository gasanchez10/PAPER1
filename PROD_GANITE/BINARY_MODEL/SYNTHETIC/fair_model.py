...
def metrics_calculator(reference):
  random.seed(10)
  model = Sequential()
  model.add(Dense(10, activation='sigmoid',input_dim=6)) # use this if doesnt work
...
results_ganite.to_csv(prefix_results+'GANITE_RESULTS_'+suffix, index=False)
